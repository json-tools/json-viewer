...
var countries = __webpack_require__("./snippets/countries.json");
var traveller = __webpack_require__("./snippets/traveller.json");
...
/***/ "./snippets/traveller.json":
/***/ (function(module, exports) {

module.exports = {"firstName":"John","middleName":null,"lastName":"Doe","document":{"type":"passport","number":"123456789","validUntil":"2020-08-23"},"hasLuggage":true,"ageAtTimeOfDeparture":42}
...
var _1602$json_value$JsonValue$getIn = F2(
	function (path, value) {
		var _p0 = path;
		if (_p0.ctor === '[]') {
			...
			switch (_p1.ctor) {
				case 'ObjectValue':
					return A2(
						...
						_1602$json_value$JsonValue$getIn(_p5),
						A2(
...
var _1602$json_value$JsonValue$encode = function (v) {
	var _p6 = v;
	switch (_p6.ctor) {
		case 'ObjectValue':
				...
				A2(
					...
					function (_p7) {
						...
						return {
							ctor: '_Tuple2',
							_0: _p8._0,
							_1: _1602$json_value$JsonValue$encode(_p8._1)
						};
					},
					_p6._0));
		case 'ArrayValue':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _1602$json_value$JsonValue$encode, _p6._0));
		case 'StringValue':
...
var _1602$json_value$JsonValue$StringValue = function (a) {
	return {ctor: 'StringValue', _0: a};
};
var _1602$json_value$JsonValue$NumericValue = function (a) {
	return {ctor: 'NumericValue', _0: a};
};
var _1602$json_value$JsonValue$NullValue = {ctor: 'NullValue'};
var _1602$json_value$JsonValue$BoolValue = function (a) {
	return {ctor: 'BoolValue', _0: a};
};
var _1602$json_value$JsonValue$ArrayValue = function (a) {
	return {ctor: 'ArrayValue', _0: a};
};
var _1602$json_value$JsonValue$ObjectValue = function (a) {
	return {ctor: 'ObjectValue', _0: a};
};
var _1602$json_value$JsonValue$decoder = function () {
	var arrayValueDecoder = A2(
		_elm_lang$core$Json_Decode$map,
		_1602$json_value$JsonValue$ArrayValue,
		_elm_lang$core$Json_Decode$list(
			_elm_lang$core$Json_Decode$lazy(
				function (_p9) {
					return _1602$json_value$JsonValue$decoder;
				})));
	var objectValueDecoder = A2(
		_elm_lang$core$Json_Decode$map,
		_1602$json_value$JsonValue$ObjectValue,
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (_p10) {
	...
	return _elm_lang$core$Json_Decode$oneOf(
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Json_Decode$null(_1602$json_value$JsonValue$NullValue),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Json_Decode$map, _1602$json_value$JsonValue$StringValue, _elm_lang$core$Json_Decode$string),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$core$Json_Decode$map, _1602$json_value$JsonValue$NumericValue, _elm_lang$core$Json_Decode$float),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$core$Json_Decode$map, _1602$json_value$JsonValue$BoolValue, _elm_lang$core$Json_Decode$bool),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _1602$json_value$JsonValue$setProperty = F3(
...
var _1602$json_value$JsonValue$setIn = F3(
							...
							function (key, _p22) {
								...
								var v = A2(
									...
									function (vv) {
										return A2(
											_elm_lang$core$Result$andThen,
											A2(_1602$json_value$JsonValue$setProperty, key, vv),
											A2(_1602$json_value$JsonValue$getIn, p, hostValue));
									},
									_p23._1);
								var _p24 = _p25;
								if (_p24.ctor === '[]') {
...
var _1602$json_value$JsonValue$setPropertyName = F3(
	function (_p26, newName, hostValue) {
		...
		var renameKey = function (val) {
			...
			if (_p28.ctor === 'ObjectValue') {
				return function (_p29) {
					return _elm_lang$core$Result$Ok(
						_1602$json_value$JsonValue$ObjectValue(_p29));
				}(
					A2(
						_elm_lang$core$List$indexedMap,
						F2(
		...
		var targetValue = A2(
			...
			A2(
				_elm_lang$core$Result$andThen,
				renameKey,
				A2(_1602$json_value$JsonValue$getIn, _p32, hostValue)));
		return A3(_1602$json_value$JsonValue$setIn, _p32, targetValue, hostValue);
	});
var _1602$json_value$JsonValue$deleteIn = F2(
				...
				switch (_p33.ctor) {
					case 'ObjectValue':
						return function (_p34) {
							return _elm_lang$core$Result$Ok(
								_1602$json_value$JsonValue$ObjectValue(_p34));
						}(
							A2(
					...
					case 'ArrayValue':
						return function (_p37) {
							return _elm_lang$core$Result$Ok(
								_1602$json_value$JsonValue$ArrayValue(_p37));
						}(
							A2(
								_elm_lang$core$List$map,
								function (_p38) {
			...
			if (_p44.ctor === 'Just') {
				return A2(
					...
					A2(
						_elm_lang$core$Result$andThen,
						rejectKey(_p44._0),
						A2(_1602$json_value$JsonValue$getIn, path, hostValue)));
			} else {
				return hostValue;
			}
		}();
		return A3(_1602$json_value$JsonValue$setIn, path, targetValue, hostValue);
	});
...
var _1602$json_viewer$Json_Viewer$boolToString = function (bv) {
	return bv ? 'true' : 'false';
};
var _1602$json_viewer$Json_Viewer$jsonTypeToString = function (t) {
	var _p0 = t;
	switch (_p0.ctor) {
		case 'JsonBoolean':
			return 'bool';
...
var _1602$json_viewer$Json_Viewer$inline = F2(
			...
			_elm_lang$html$Html$span,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(
						...
						_1602$json_viewer$Json_Viewer$jsonTypeToString(jsonType))),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _1602$json_viewer$Json_Viewer$update = F2(
	function (msg, model) {
		var _p1 = msg;
		var _p2 = _p1._0;
		return A2(_elm_lang$core$List$member, _p2, model.expandedNodes) ? _elm_lang$core$Native_Utils.update(
			model,
			{
				expandedNodes: A2(
					_elm_lang$core$List$filter,
			...
			model,
			{
				expandedNodes: {ctor: '::', _0: _p2, _1: model.expandedNodes}
			});
	});
var _1602$json_viewer$Json_Viewer$init = function (jsonValue) {
	return {
		expandedNodes: {ctor: '[]'},
		jsonValue: jsonValue
	};
};
var _1602$json_viewer$Json_Viewer$Model = F2(
	function (a, b) {
		return {expandedNodes: a, jsonValue: b};
	});
var _1602$json_viewer$Json_Viewer$Toggle = function (a) {
	return {ctor: 'Toggle', _0: a};
};
var _1602$json_viewer$Json_Viewer$JsonNull = {ctor: 'JsonNull'};
var _1602$json_viewer$Json_Viewer$JsonNumber = {ctor: 'JsonNumber'};
var _1602$json_viewer$Json_Viewer$JsonString = {ctor: 'JsonString'};
var _1602$json_viewer$Json_Viewer$JsonBoolean = {ctor: 'JsonBoolean'};
var _1602$json_viewer$Json_Viewer$viewComponent = F3(
	function (expandedNodes, path, jv) {
		var _p3 = jv;
		switch (_p3.ctor) {
			case 'BoolValue':
				return A2(
					_1602$json_viewer$Json_Viewer$inline,
					_1602$json_viewer$Json_Viewer$JsonBoolean,
					_elm_lang$html$Html$text(
						_1602$json_viewer$Json_Viewer$boolToString(_p3._0)));
			case 'NumericValue':
				return A2(
					_1602$json_viewer$Json_Viewer$inline,
					_1602$json_viewer$Json_Viewer$JsonNumber,
					_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(_p3._0)));
			case 'StringValue':
				return A2(
					_1602$json_viewer$Json_Viewer$inline,
					_1602$json_viewer$Json_Viewer$JsonString,
					_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(_p3._0)));
			case 'NullValue':
				return A2(
					_1602$json_viewer$Json_Viewer$inline,
					_1602$json_viewer$Json_Viewer$JsonNull,
			...
			case 'ObjectValue':
				return A2(_elm_lang$core$List$member, path, expandedNodes) ? A2(
					...
					A2(
						...
						function (_p4) {
							var _p5 = _p4;
							return A4(_1602$json_viewer$Json_Viewer$viewChildProp, _p5._0, _p5._1, path, expandedNodes);
						},
						_p3._0)) : _elm_lang$html$Html$text('');
			default:
				var _p6 = _p3._0;
				return A2(_elm_lang$core$List$member, path, expandedNodes) ? A2(
					_elm_lang$html$Html$div,
					...
					A2(
						...
						F2(
							function (index, v) {
								return A4(
									_1602$json_viewer$Json_Viewer$viewChildProp,
					...
					_elm_lang$html$Html$span,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_1602$json_viewer$Json_Viewer$Toggle(path)),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _1602$json_viewer$Json_Viewer$viewChildProp = F4(
	function (k, v, path, expandedNodes) {
		var isExpandable = function () {
			var _p7 = v;
			switch (_p7.ctor) {
				case 'ObjectValue':
					return !_elm_lang$core$List$isEmpty(_p7._0);
				case 'ArrayValue':
					return !_elm_lang$core$List$isEmpty(_p7._0);
				default:
					return false;
		...
		var childExpanded = A2(_elm_lang$core$List$member, childPath, expandedNodes);
		var toggle = A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('json-viewer__toggle'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_1602$json_viewer$Json_Viewer$Toggle(childPath)),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: childExpanded ? _elm_lang$html$Html$text('-') : _elm_lang$html$Html$text('+'),
				_1: {ctor: '[]'}
			});
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'json-viewer', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'json-viewer__child-value', _1: true},
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
			...
			{
				ctor: '::',
				_0: isExpandable ? toggle : _elm_lang$html$Html$text(''),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$span,
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'json-viewer__key', _1: true},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'json-viewer__key--expandable', _1: isExpandable},
											_1: {ctor: '[]'}
										}
									}
								}),
					...
					_1: {
									...
									return A2(
										...
										},
										{
											...
											_0: (_elm_lang$core$Native_Utils.cmp(
												...
												5) > 0) ? _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'{ ',
													A2(_elm_lang$core$Basics_ops['++'], s, ', ... }'))) : _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'{ ',
						...
						_1: {
							ctor: '::',
							_0: A3(_1602$json_viewer$Json_Viewer$viewComponent, expandedNodes, childPath, v),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _1602$json_viewer$Json_Viewer$view = function (model) {
	var _p12 = model.jsonValue;
	switch (_p12.ctor) {
		case 'ObjectValue':
			return A4(
				_1602$json_viewer$Json_Viewer$viewChildProp,
		...
		default:
			return A3(
				_1602$json_viewer$Json_Viewer$viewComponent,
				model.expandedNodes,
				{ctor: '[]'},
				model.jsonValue);
	}
...
var _1602$json_viewer$Snippets$makeJsonViewer = function (v) {
	return _1602$json_viewer$Json_Viewer$init(
		A2(
			_elm_lang$core$Result$withDefault,
			_1602$json_value$JsonValue$NullValue,
			A2(
				_elm_lang$core$Json_Decode$decodeValue,
				_1602$json_value$JsonValue$decoder,
				_elm_lang$core$Json_Encode$object(v))));
};
var _1602$json_viewer$Snippets$getSnippetTitle = function (ds) {
	var _p0 = ds;
	if (_p0.ctor === 'Traveller') {
		return 'Traveller';
	} else {
		return 'Countries';
	}
};
var _1602$json_viewer$Snippets$Countries = {ctor: 'Countries'};
var _1602$json_viewer$Snippets$Traveller = {ctor: 'Traveller'};

var _1602$json_viewer$Demo$loadSnippet = _elm_lang$core$Native_Platform.outgoingPort(
	'loadSnippet',
	function (v) {
		return v;
	});
var _1602$json_viewer$Demo$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		jsonViewer: _1602$json_viewer$Json_Viewer$init(_1602$json_value$JsonValue$NullValue),
		showcase: _1602$json_viewer$Snippets$Traveller
	},
	{
		ctor: '::',
		_0: _1602$json_viewer$Demo$loadSnippet('traveller'),
		_1: {ctor: '[]'}
	});
var _1602$json_viewer$Demo$update = F2(
			...
			case 'JsonViewerMsg':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							jsonViewer: A2(_1602$json_viewer$Json_Viewer$update, _p0._0, model.jsonViewer)
						}),
					{ctor: '[]'});
			case 'SetShowcase':
				var _p1 = _p0._0;
				return A2(
					...
					{
						ctor: '::',
						_0: _1602$json_viewer$Demo$loadSnippet(
			...
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							jsonViewer: _1602$json_viewer$Json_Viewer$init(
								A2(
									_elm_lang$core$Result$withDefault,
									_1602$json_value$JsonValue$NullValue,
									A2(_elm_lang$core$Json_Decode$decodeValue, _1602$json_value$JsonValue$decoder, _p0._0)))
						}),
					{ctor: '[]'});
		}
	});
var _1602$json_viewer$Demo$snippet = _elm_lang$core$Native_Platform.incomingPort('snippet', _elm_lang$core$Json_Decode$value);
var _1602$json_viewer$Demo$Model = F2(
	function (a, b) {
		return {jsonViewer: a, showcase: b};
	});
var _1602$json_viewer$Demo$LoadSnippet = function (a) {
	return {ctor: 'LoadSnippet', _0: a};
};
var _1602$json_viewer$Demo$subscriptions = function (_p2) {
	return _1602$json_viewer$Demo$snippet(_1602$json_viewer$Demo$LoadSnippet);
};
var _1602$json_viewer$Demo$SetShowcase = function (a) {
	return {ctor: 'SetShowcase', _0: a};
};
var _1602$json_viewer$Demo$snippetTab = F2(
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_1602$json_viewer$Demo$SetShowcase(snippet)),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_1602$json_viewer$Snippets$getSnippetTitle(snippet)),
				_1: {ctor: '[]'}
			});
	});
var _1602$json_viewer$Demo$topbar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			_1602$json_viewer$Demo$snippetTab(model.showcase),
			{
				ctor: '::',
				_0: _1602$json_viewer$Snippets$Traveller,
				_1: {
					ctor: '::',
					_0: _1602$json_viewer$Snippets$Countries,
					_1: {ctor: '[]'}
				}
			}));
};
var _1602$json_viewer$Demo$JsonViewerMsg = function (a) {
	return {ctor: 'JsonViewerMsg', _0: a};
};
var _1602$json_viewer$Demo$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Showcase: ',
							_1602$json_viewer$Snippets$getSnippetTitle(model.showcase))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					_1602$json_viewer$Demo$JsonViewerMsg,
					_1602$json_viewer$Json_Viewer$view(model.jsonViewer)),
				_1: {ctor: '[]'}
			}
		});
};
var _1602$json_viewer$Demo$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _1602$json_viewer$Demo$topbar(model),
			_1: {
				ctor: '::',
				_0: _1602$json_viewer$Demo$content(model),
				_1: {ctor: '[]'}
			}
		});
};

var _1602$json_viewer$Main$main = _elm_lang$html$Html$program(
	{init: _1602$json_viewer$Demo$init, update: _1602$json_viewer$Demo$update, view: _1602$json_viewer$Demo$view, subscriptions: _1602$json_viewer$Demo$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _1602$json_viewer$Main$main !== 'undefined') {
    _1602$json_viewer$Main$main(Elm['Main'], 'Main', undefined);
}
...
var snippets = __webpack_require__("./snippets/index.js");
var Elm = __webpack_require__("./src/Main.elm");

var app = Elm.Main.fullscreen();
app.ports.loadSnippet.subscribe(function (x) {
  return app.ports.snippet.send(snippets[x]);
});
